...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('TASK_ASSIGNED', 'TASK_REASSIGNED', 'TASK_COMPLETED', 'TASK_OVERDUE', 'TASK_DUE_SOON', 'COMMENT_ADDED', 'STATUS_CHANGED', 'TASK_DELETED');

-- CreateEnum
CREATE TYPE "ActivityType" AS ENUM ('TASK_CREATED', 'TASK_UPDATED', 'TASK_STATUS_CHANGED', 'TASK_ASSIGNED', 'TASK_DELETED', 'COMMENT_ADDED', 'COMMENT_DELETED');
